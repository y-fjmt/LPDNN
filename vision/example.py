...
def main():
    ...
    if use_cuda:
        cuda_kwargs = {"num_workers": 32, "pin_memory": True, "shuffle": True}
    ...
    dataset1 = datasets.MNIST("vision/data", train=True, download=True, transform=transform)
    dataset2 = datasets.MNIST("vision/data", train=False, transform=transform)
